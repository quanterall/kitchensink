...
// name changed, errors have their source locations printed with the log items
...
// Go standard library package 'log' is fixed to expose the possibility of
// setting the flags via init() functions or in the main() of an application.
//
